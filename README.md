...
The assistant performs Retrieval-Augmented Generation (RAG) using FAISS vector search and local Llama 3.1 inference through Ollama. Questions are answered using relevant content retrieved from multiple uploaded documents, with document-aware source citations for transparency and traceability.
